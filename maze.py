...
class Maze():
    def __init__(self, filename):
        ...
        # Read file and set height and the width of maze
    ...
    def solve(self):
        ...
        frontier = StackFrontier() # Change it to QueueFrontier() for BFS (Breadth-First Search)
        frontier.add(start)
        ...
        while True:
            ...
            # If node is the goal, then we have a soluttion
